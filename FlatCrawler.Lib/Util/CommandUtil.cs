...
public static class CommandUtil
{
    ...
    private static FlatBufferNode ReadNodeAndTrack(this FlatBufferNodeField node, int fieldIndex, byte[] data, string type)
    {
    ...
    public static FlatBufferNode ReadNodeAndTrack(this FlatBufferNodeField node, int fieldIndex, byte[] data, TypeCode code, bool asArray)
    {
